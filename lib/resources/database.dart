...
/// getSeries
/// @param List<String> timeValues,
/// @param int max
/// @return List<charts.Series<Balance, String>>
...
List<charts.Series<Balance, String>> getSeries(
  String key,
  int index, {
  int max = 1000,
}) {
...
List<User> getUser() {
  ...
  users.add(User("Sidhu Moosewala",
      "https://cdn-images-1.medium.com/max/500/1*XLkbchlQJFq3YcTKaD_BlQ.jpeg"));
  users.add(User("Bhavneet Singh",
